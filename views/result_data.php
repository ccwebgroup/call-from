...
function insertSearch($phoneId)
{
		...
		$db->exec("insert into cf_search_details set searchPhoneId='".$phoneId."', searchIp='".$_SERVER['REMOTE_ADDR']."',searchReferrer='".$_SERVER['GATEWAY_INTERFACE']."',searchOs='".$userOs."',searchBrowser='".$userBrowser."',searchDateTime=now()");
}
...
else
{
	if (isset($result->phone)) 
	{
		 ...
		 else
		 {
			...
			//echo $result->phone['line_type'];die;
			 if($result->phone['line_type'])
			 {
			 	/** 
			 	* @deprecated
				* -Because of the API request limit. We need to scrapre the data instead of api calling.
			 	*/
		...
		<h3>Phone number <?php echo $not ?> found </h3>
				...
				<div class="row" style="margin-bottom: 20px;">
					<div class="col-md-12">
						<strong>Rating: </strong> <?php echo number_format($rating, 2)?> / 10
						<input id="currRating" name="input-3" value="<?php echo number_format($rating, 2)?>" class="rating-loading">
					</div>
				</div>

				<div class="map" >
		         <iframe width="100%" height="250" frameborder="0" style="border:0" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="
...
{
?>
	<h3>Search a number for information</h3>
	<p>Carrier owner of phone number</p>
		<div class="jumbotron" style="padding: 20px;">
			<h3>Telepone Number <span style="color:#41C0F9;">(###) ##-####</span></h3>
	...
	<div class="map col-md-12">
		...
		<iframe src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d94711.97653743453!2d-72.54634144999999!3d42.11284045!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x89e6e62c08e4b81f%3A0x1d1808da41b9aabd!2sSpringfield%2C+MA%2C+USA!3m2!1d42.101483099999996!2d-72.589811!5e0!3m2!1sen!2sin!4v1432107888321" width="100%" height="250" frameborder="0" style="border:0"></iframe>
		<?php else: ?>
					<iframe width="100%" height="250" frameborder="0" style="border:0" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="
http://maps.google.com/maps
?f=q
...
{
	$('#currRating').rating({displayOnly: true, min: 0, max: 10, step: 0.1, stars: 10, size : 'xs'});
})
</script>